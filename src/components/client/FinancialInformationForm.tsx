...
export const FinancialInformationForm: React.FC<FinancialFormProps> = ({ sections, onSave }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Financial Information Form</h2>
      ...
      {currentSection && (
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-4">{currentSection.title}</h3>
      ...
      {/* Save Status */}
      {saving && <div className="mt-4 text-sm text-gray-500">Saving changes...</div>}
