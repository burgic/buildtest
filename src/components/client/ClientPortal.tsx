              ...
              <div className="flex items-center space-x-3">
                {savingStates[section.id] ? (
                  ...
                  <div className={`w-4 h-4 rounded-full border ${
                    activeSection === section.id ? 'border-white' : 'border-gray-600'
                  }`} />
                )}
      ...
      <div className="col-span-9">
        <div className="bg-[#1D1D1F] rounded-xl p-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-800">
            <button className="flex items-center space-x-2 px-4 py-2 bg-[#2D2D2F] rounded-lg text-gray-300 hover:bg-[#3D3D3F] transition-colors">
